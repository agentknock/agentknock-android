...
@Composable private fun SecretDetailPreview() = PreviewScreen { SecretPage(previewSecret) }
...
@Composable private fun SecretSshPreview() = PreviewScreen { SecretPage(previewSshSecret) }

@PreviewTest
@Preview(
    name = "Light",
    group = "secret-unavailable",
    widthDp = 360,
    heightDp = 800,
    locale = "en",
    uiMode = Configuration.UI_MODE_NIGHT_NO,
    ...
    SecretPage(
        previewSecret.copy(
            environmentVariables =
                previewSecret.environmentVariables.map { it.copy(valueAvailable = false) }
        )
    )
}
    ...
    SecretDetail(
        ...
        actions =
            SecretDetailActions(
                ...
                onEditVariable = {},
                onReveal = {},
                onReadValue = { "m8Jq4wZr7vNp2xTk9sLc" },
                onCopy = {},
                onSetApprovalMode = {},
