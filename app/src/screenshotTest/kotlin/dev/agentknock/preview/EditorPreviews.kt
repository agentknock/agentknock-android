...
private fun CreateSecretPreview() = PreviewScreen {
    SecretEditorScreen(
        SecretEditorState(null, "", "", SecretType.ENVIRONMENT),
        true,
        {},
        {},
        {},
...
private fun CreateSshKeyPreview() = PreviewScreen {
    SecretEditorScreen(
        SecretEditorState(null, "deploy-ssh-staging", "", SecretType.SSH),
        true,
        {},
        {},
        {},
...
private fun ReplaceSshKeyPreview() = PreviewScreen {
    SshKeyEditorScreen(
        SshKeyEditorState(previewSshSecret.id, previewSshSecret.name, previewSshKey, SshKeyDraft()),
        true,
        {},
        {},
        {},
...
private fun ImportSshKeyPreview() = PreviewScreen {
    SshKeyEditorScreen(
        SshKeyEditorState(
            ...
            previewSshKey,
            SshKeyDraft(
                inputMode = SshKeyInputMode.IMPORT,
                error = "This is not a supported OpenSSH private key.",
            ),
        ),
        true,
        {},
...
@Composable
private fun DiscardChangesPreview() = PreviewScreen {
    DiscardChangesDialog(true, {}, {}, modifier = previewDialogModifier())
}
...
private fun DeleteSecretPreview() = PreviewScreen {
    DeleteDialog(
        "Delete ${previewSecret.name}?",
        "This secret and its stored values will be permanently deleted.",
        {},
        {},
