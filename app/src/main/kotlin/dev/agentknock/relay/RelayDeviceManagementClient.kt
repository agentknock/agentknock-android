...
internal class HttpRelayDeviceManagementClient(
    ...
    override suspend fun setPairingEnabled(
        ...
        post(
            ...
            json.decodeFromString<PairingAdmissionResponse>(body).enabled == enabled
        }
    ...
    override suspend fun deleteDevice(
        ...
        post(
            ...
            json.decodeFromString<DeviceDeletionResponse>(body).deleted
        }
...
@Serializable private data class PairingAdmissionRequest(val enabled: Boolean)

@Serializable
private data class PairingAdmissionResponse(@SerialName("pairing_enabled") val enabled: Boolean)

@Serializable private data class DeviceDeletionResponse(val deleted: Boolean)
