...
private val LightAgentknockColors =
    AgentknockColors(
...
private val DarkAgentknockColors =
    AgentknockColors(
        brand = Color(0xFFE3A43B),
        onBrand = Color(0xFF22252A),
...
private val LocalAgentknockColors =
    staticCompositionLocalOf<AgentknockColors> {
        error("Agentknock colors were not provided")
    }

val MaterialTheme.agentknockColors: AgentknockColors
    @Composable @ReadOnlyComposable get() = LocalAgentknockColors.current
...
fun AgentknockTheme(
    ...
    CompositionLocalProvider(
        LocalAgentknockColors provides
            if (darkTheme) {
