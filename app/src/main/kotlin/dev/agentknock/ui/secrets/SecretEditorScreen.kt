    ...
    Scaffold(
        ...
        Box(Modifier.fillMaxSize().padding(padding).consumeWindowInsets(padding).imePadding()) {
            Column(
                ...
                if (secret != null) {
                    Text(
                        "Commands that request this secret by name must use the new name after renaming.",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant,
                    )
                }
                        ...
                        enabled =
                            enabled &&
                                ...
                                editor.environmentVariables
                                    ...
                                    .let { variables ->
                                        variables.all {
                                            environmentVariableName.matches(it.name)
                                        } &&
                                            variables.map { it.name }.distinct().size ==
                                                variables.size
                                    } &&
                                (secret == null ||
                                    name != secret.name ||
