...
internal fun SecretApprovalMode.displayName(): String =
    when (this) {
            ...
            text = {
                Column(
                    ...
                    listOf(
                            ...
                            "AI" to
                                "Use your instructions to approve, deny, or ask you. Requires a subscription.",
                    ...
                    Text(
                        "Muted selections follow the default. Choose a setting to override it, or tap Use default to follow it again."
                    )
                }
            },
            confirmButton = {
...
internal fun ApprovalModeRow(
    ...
    val canExploreAi =
        aiReviewAccess == AiReviewAccess.ACTIVE || aiReviewAccess == AiReviewAccess.INACTIVE
    Column(
        ...
        SingleChoiceSegmentedButtonRow(Modifier.fillMaxWidth().height(IntrinsicSize.Min)) {
            approvalModes.forEachIndexed { index, mode ->
                val inactiveAi =
                    mode == SecretApprovalMode.ASK_AI && aiReviewAccess == AiReviewAccess.INACTIVE
                SegmentedButton(
                    ...
                    modifier =
                        Modifier.fillMaxHeight().semantics {
                            ...
                            else if (selected == mode && inherited)
                                stateDescription = "Uses default"
                        },
                        ...
                        if (inactiveAi) {
                            ...
                            SegmentedButtonDefaults.colors(
                                activeContainerColor =
                                    if (inherited) MaterialTheme.colorScheme.secondaryContainer
                                    else MaterialTheme.colorScheme.primary,
                                inactiveContainerColor =
                                    MaterialTheme.colorScheme.surfaceContainerHighest,
                                inactiveContentColor = mutedText,
                                activeContentColor =
                                    if (inherited) MaterialTheme.colorScheme.onSecondaryContainer
        ...
        val explanation =
            when (aiReviewAccess) {
                AiReviewAccess.INACTIVE ->
                    if (selected == SecretApprovalMode.ASK_AI) {
